    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $btnEdit = '<a href="' . route('admin.blog.category.edit', $query->id) . '" class="btn btn-success btn-sm mx-2"><i class="fas fa-edit"></i></a>';
                $btnDelete = '<a href="' . route('admin.blog.category.destroy', $query->id) . '" class="btn btn-danger btn-sm delete-item"><i class="fas fa-trash"></i></a>';
